...
<div class="container" style="margin-top: 3%; margin-left: 20%; width: 75%;">
  <div class="panel panel-default">
    <div class="panel-heading">Giant Slide Details</div>
      ...
      <div class="table-responsive">
        <table class="table table-bordered table-hover">
          ...
          <tbody>
            ...
            <?php $sql=$db->query("Select * from giant_slide ORDER BY id desc");
           ...
           <tr>
                ...
                <td><?php echo $user['gskid']; ?></td>
                <td><?php echo $user['gsadult']; ?></td>
                <td><?php echo $user['gsdisc']; ?></td> 
