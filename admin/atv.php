...
<div class="container" style="margin-top: 3%; margin-left: 20%; width: 75%;">
  <div class="panel panel-default">
    <div class="panel-heading">ATV Details</div>
      ...
      <div class="table-responsive">
        ...
        <table class="table table-bordered table-hover">
          ...
          <tbody>
            ...
            <?php $sql=$db->query("Select * from atv_truck ORDER BY id desc");
           ...
           <tr>
                ...
                <td><?php echo $user['akid']; ?></td>
                <td><?php echo $user['aadult']; ?></td>
                <td><?php echo $user['adisc']; ?></td> 
