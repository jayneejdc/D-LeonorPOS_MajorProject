...
<div class="container" style="margin-top: 3%; margin-left: 20%; width: 75%;">
  <div class="panel panel-default">
    <div class="panel-heading">Zipline Details</div>
      ...
      <div class="table-responsive">
        <table class="table table-bordered table-hover">
          ...
          <tbody>
            ...
            <?php $sql=$db->query("Select * from zipline ORDER BY id desc");
           ...
           <tr>
                ...
                <td><?php echo $user['zkid']; ?></td>
                <td><?php echo $user['zadult']; ?></td>
                <td><?php echo $user['zdisc']; ?></td> 
