...
<div class="container" style="margin-top: 3%; margin-left: 20%; width: 75%;">
  <div class="panel panel-default">
    <div class="panel-heading">Go Kart Details</div>
        ...
        <table class="table table-bordered table-hover">
          <thead>
            <tr>
              ...
              <th colspan="3"><center>Go Kart</center></th>
          ...
          <tbody>
            ...
            <?php $sql=$db->query("Select * from go_kart ORDER BY id desc");
           ...
           <tr>
                ...
                <td><?php echo $user['gkkid']; ?></td>
                <td><?php echo $user['gkadult']; ?></td>
                <td><?php echo $user['gkdisc']; ?></td> 
