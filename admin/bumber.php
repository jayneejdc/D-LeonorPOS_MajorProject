...
<div class="container" style="margin-top: 3%; margin-left: 20%; width: 75%;">
  <div class="panel panel-default">
    <div class="panel-heading">Bumper Boat Details</div>
        ...
        <table class="table table-bordered table-hover">
          <thead>
            <tr>
              ...
              <th colspan="3"><center>Bumper Boat</center></th>
          ...
          <tbody>
            ...
            <?php $sql=$db->query("Select * from bumper_boat ORDER BY id desc");
           ...
           <tr>
                ...
                <td><?php echo $user['bbkid']; ?></td>
                <td><?php echo $user['bbadult']; ?></td>
                <td><?php echo $user['bbdisc']; ?></td> 
