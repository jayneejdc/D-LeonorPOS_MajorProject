        ...
        <table class="table table-bordered table-striped">
           <tr>
            ...
            <tr>
                ...
                <td><i data="<?php echo $user['id'];?>" class="status_del btn <?php echo ($user['status'])? 'btn-danger' : 'btn-danger'?>"><?php echo ($user['status'])? 'Delete' : 'Delete'?></i></td>
            </tr>
           <?php endforeach; ?>
        </table>
  </div>
...
<script type="text/javascript">
$(document).on('click','.status_del',function(){
var status = ($(this).hasClass("btn-success")) ? '0' : '1';
var msg = (status=='0')? 'Delete' : 'Delete';
if(confirm("Are you sure you want to "+ msg)){
  var current_element = $(this);
  url = "ajax2.php";
  $.ajax({
