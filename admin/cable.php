...
<div class="container" style="margin-top: 3%; margin-left: 20%; width: 75%;">
  <div class="panel panel-default">
    <div class="panel-heading">Cable Car Details</div>
        ...
        <table class="table table-bordered table-hover">
          <thead>
            <tr>
              ...
              <th colspan="3"><center>Cable Car</center></th>
          ...
          <tbody>
            ...
            <?php $sql=$db->query("Select * from cable_car ORDER BY id desc");
           ...
           <tr>
                ...
                <td><?php echo $user['cckid']; ?></td>
                <td><?php echo $user['ccadult']; ?></td>
                <td><?php echo $user['ccdisc']; ?></td> 
